...
@interface BridgeSession (SWIFT_EXTENSION(ContentComponent))
...
SWIFT_CLASS("_TtC16ContentComponent28PresentationSynchronizingNow")
...
@interface SessionAction (SWIFT_EXTENSION(ContentComponent))
...
@interface SessionEventAction (SWIFT_EXTENSION(ContentComponent))
@property (nonatomic, strong) NSDate * _Nullable created;
